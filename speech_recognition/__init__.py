...
class Recognizer(AudioSource):
    ...
    @staticmethod
    def samples_to_flac(source, frame_data):
        ...
        if flac_converter is None:
            ...
            if system == "Windows" and platform.machine() in ["i386", "x86", "x86_64", "AMD64"]:
                ...
                raise OSError("FLAC conversion utility not available - consider installing the FLAC \
                        command line application using `brew install flac` or your operating system's equivalent")
        ...
        process = subprocess.Popen("\"%s\" --stdout --totally-silent --best -" % flac_converter, stdin=subprocess.PIPE,
